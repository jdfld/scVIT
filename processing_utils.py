...
def pca(adata,plot=False,n_comps=50):
  sc.tl.pca(adata,svd_solver = 'arpack',n_comps=n_comps) # performs pca for adata with default arnoldi package for solving large scale eigenvalue matrices.
  if plot:
